...
var modelData: [CompaniesDetails] = [
    ...
    CompaniesDetails(image: "Comp4", title: "STC", caption: "Saudi digital enabler of telecommunications services in the Kingdom of Saudi Arabia, and among the operators in the Middle East."),
    
    CompaniesDetails(image: "Comp6", title: "Almarai", caption: "Specializes in food and beverage manufacturing and distribution."),
    
    CompaniesDetails(image: "Comp7", title: "Dar Alarkan", caption: "Saudi digital enabler of telecommunications services in the Kingdom of Saudi Arabia, and among the operators in the Middle East.")
]
