...
struct HomeView: View {
    ...
    var body: some View {
        VStack{
            HStack{
                HStack{
                    Text("Home").foregroundColor(Color("Primary")).font(Font.custom("SF Pro", size: 21))
        ...
        }.padding(EdgeInsets(top: 0, leading: 24, bottom: 0, trailing: 24)).frame(maxHeight: .infinity,alignment: .top)
    }
}
